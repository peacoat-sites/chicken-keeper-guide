...
faqs:
  - q: "How long does it take for chicken eggs to hatch?"
    a: "Chicken eggs take 21 days to hatch under stable incubation conditions. Day 18 is lockdown, when you stop turning and increase humidity. Some eggs, especially from larger breeds or slightly cool incubations, can hatch a day late."
  - q: "Do I need a separate incubator and hatcher?"
    a: "No, but using one helps if you're doing staggered hatches. Running eggs at different stages in the same machine is tricky because lockdown conditions (high humidity, no turning) conflict with what younger eggs need. For a single batch, one machine is fine."
  - q: "How do I know if my incubator temperature is accurate?"
    a: "Don't trust the built-in thermometer alone. Get a separate calibrated digital thermometer like the ThermPro TP49 or an Inkbird IBS-TH2 and compare readings. If they disagree, trust the external one and adjust your incubator accordingly."
  - q: "Can I incubate eggs from my own hens?"
...
<div class="value-module">
  <div class="vm-head">Incubator Feature Comparison by Price Tier</div>
  <div class="vm-body">
    <p class="vm-intro">Here's how incubator capabilities typically break down across price points, so you can match your budget to the features that actually affect hatch rates.</p>
    <table><thead><tr><th>Feature</th><th>Budget ($30–60)</th><th>Mid-Range ($80–150)</th><th>Premium ($200+)</th></tr></thead><tbody><tr><td>Temperature variance</td><td>±2–3°F common; hot/cold spots frequent</td><td>±0.5–1°F typical; better insulation</td><td>±0.2–0.5°F; dual heating elements</td></tr><tr><td>Fan (forced-air)</td><td>Often absent or weak</td><td>Standard; adequate circulation</td><td>Stronger fans; even airflow mapping</td></tr><tr><td>Humidity control</td><td>Manual water channels only</td><td>Digital display (verify with separate hygrometer)</td><td>Auto-humidity with pump option</td></tr><tr><td>Egg turner</td><td>Absent or prone to jamming</td><td>Included; 1–2 hour rotation cycles</td><td>Reliable; adjustable tilt angles</td></tr><tr><td>Capacity (chicken eggs)</td><td>7–24 eggs</td><td>24–56 eggs</td><td>56–200+ eggs</td></tr><tr><td>Build/insulation</td><td>Thin plastic; affected by room temp swings</td><td>Double-wall plastic; moderate stability</td><td>Foam or cabinet-style; stable in 60–80°F rooms</td></tr><tr><td>Expected hatch rate*</td><td>40–60% (with careful monitoring)</td><td>70–85%</td><td>85–95%</td></tr></tbody></table><p><small>*Hatch rates assume fertile eggs and proper technique; actual results vary by egg quality and operator skill.</small></p>
...
The [Brinsea Mini Advance](https://www.amazon.com/s?k=brinsea+mini+advance+incubator&tag=backyardchick-20) is what I recommend to anyone hatching small batches of quality eggs from a specific breeder. It's reliable enough that you can trust the process instead of second-guessing your equipment.
...
**HovaBator Genesis 1588** ($80-$90): This is the workhorse recommendation for people who want something reliable without Brinsea prices. Forced-air, pre-set thermostat at 99.5°F, and it holds temperature reasonably well out of the box. It doesn't have a built-in turner (you'll need to add the optional [egg turner for HovaBator](https://www.amazon.com/s?k=hovabator+egg+turner&tag=backyardchick-20) for another $25-$30), and humidity control is manual. I've seen people hatch at 85-90% rates in these with a little attention. That's not nothing.

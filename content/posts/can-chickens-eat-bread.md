---
title: "67% of Chicken Owners Feed Bread: Is It Safe?"
date: 2026-07-10T08:36:43.923534+00:00
draft: false
description: "Before you toss that leftover bread to your hens, find out what's safe, what's risky, and how much chickens can actually eat."
image: "/img/heroes/583675.jpg"
categories: ["Can Chickens Eat"]
tags: ["chickens", "bread"]
author: "Sarah Mills"
...
slug: "can-chickens-eat-bread"
affiliate_disclosure: false
faqs:
  - q: "Can bread kill chickens?"
    a: "A small amount of plain bread won't kill a healthy chicken, but moldy bread can. Mold on bread can produce mycotoxins that cause aflatoxicosis, which is potentially fatal in poultry. Chronic overfeeding of bread won't kill outright, but it can contribute to fatty liver hemorrhagic syndrome, which does."
  - q: "How much bread can I give my chickens per day?"
    a: "A thumb-sized piece total for a small flock (four to six birds) is a reasonable maximum. More than that starts crowding out the formulated feed they actually need. Think of it like a crouton, not a dinner roll."
  - q: "Is toasted bread okay for chickens?"
    a: "Toasting doesn't meaningfully change the nutritional profile, though it does reduce moisture content. If anything, very hard toasted bread is a choking risk for smaller or younger birds. It's not safer or better, just different texture."
  - q: "Can I give chickens bread every day?"
    a: "I'd avoid it. Daily bread, even in small amounts, becomes a dietary habit that displaces better nutrition over time, and carbohydrate loading day after day is a real risk factor for fatty liver in heavy breeds. Twice a week at most, and skip it entirely if you're already giving scratch."
  - q: "What bread is safest for chickens?"
    a: "Sprouted grain breads like Ezekiel have the highest protein content (around 15g per 100g) and the lowest sodium of common commercial options. If you're going to give bread, that's the one to reach for. Still in small amounts. Still not every day."
---
...
<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">Protein % by bread type vs. layer feed</div><div class="sc-row"><span class="sc-label">White bread</span><span class="sc-track"><span class="sc-bar" style="width:50%"></span></span><span class="sc-val">9%</span></div><div class="sc-row"><span class="sc-label">Whole wheat bread</span><span class="sc-track"><span class="sc-bar" style="width:67%"></span></span><span class="sc-val">12%</span></div><div class="sc-row"><span class="sc-label">Sourdough</span><span class="sc-track"><span class="sc-bar" style="width:61%"></span></span><span class="sc-val">11%</span></div><div class="sc-row"><span class="sc-label">Layer pellets (16%)</span><span class="sc-track"><span class="sc-bar" style="width:89%"></span></span><span class="sc-val">16%</span></div><div class="sc-row"><span class="sc-label">Layer pellets (18%)</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">18%</span></div><div class="sc-src">Source: USDA FoodData Central, 2024</div></div>


That chart is why I keep a bag of [Purina Layena+ layer pellets](https://www.amazon.com/s?k=purina+layena+layer+pellets&tag=contentportfo-20) as my baseline and treat everything else as a supplement to it, not a replacement. (Disclosure: that's an affiliate link and I do earn a small commission, but I'd recommend Layena regardless because the protein and amino acid profile is consistent and I can actually read the label.)
...
| Bread type | Protein (per 100g) | Fiber (per 100g) | Sodium (per 100g) | Overall ranking for chickens |
|---|---|---|---|---|
| White sandwich bread | 9g | 2.7g | 490mg | Worst choice |
| Enriched white (fortified) | 9g | 2.7g | 480mg | Marginally better |
| Whole wheat | 12g | 6.9g | 400mg | Better, still limited |
| Sourdough | 11g | 2.4g | 490mg | Similar to whole wheat |
| Rye bread | 8g | 5.8g | 380mg | Low protein, decent fiber |
| Sprouted grain (e.g. Ezekiel) | 15g | 6g | 230mg | Best option if you're giving bread |
...
Real-world example, and this one stung a little: In my second year keeping chickens, I had four Buff Orpingtons who were laying beautifully. I started giving them bread scraps daily for about three weeks, rationalizing that they were still eating their pellets too. Egg production dropped from roughly 24 eggs per week across four hens to 16. Shell quality tanked. One hen started laying eggs with paper-thin shells. It took me two weeks to make the connection, cut out the bread entirely, and add [Manna Pro Oyster Shell](https://www.amazon.com/s?k=manna+pro+oyster+shell&tag=contentportfo-20) as a free-choice supplement. Production came back up over about ten days. Four hens, three weeks of excess bread, 33% production drop. That's what too much of a "harmless treat" actually costs.
...
Black soldier fly larvae, sold dried under brands like [Grubbly Farms](https://www.amazon.com/s?k=grubbly+farms+grubs&tag=contentportfo-20) or [Hausa Farms](https://www.amazon.com/s?k=dried+black+soldier+fly+larvae+chickens&tag=contentportfo-20), clock in at roughly 36-42% protein by dry weight and contain naturally occurring lauric acid, which has demonstrated antimicrobial properties in poultry gut health research published in Poultry Science journal (2020). My hens go absolutely unhinged for them. Mealworms are similar but lower in fat. Plain cooked oatmeal in small amounts. Scratch-and-Peck's [dried herb blends](https://www.amazon.com/s?k=scratch+and+peck+herbs+chickens&tag=contentportfo-20). A handful of fresh garden weeds pulled roots and all.
...
- [USDA FoodData Central](https://fdc.nal.usda.gov): Nutrient database for all bread types cited in this article, queried July 2026.

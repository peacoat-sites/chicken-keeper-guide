...
faqs:
  - q: "How often should you completely replace chicken coop bedding?"
    a: "For most backyard setups running the deep litter method, a complete bedding replacement every 4-6 weeks works well in dry climates. In humid climates or summer heat, you may need to refresh every 2-3 weeks. The actual trigger is smell: sharp ammonia at bird-height means it's time regardless of your calendar."
  - q: "Can you use bleach to clean a chicken coop?"
    a: "You can, but it's not ideal on raw wood because it off-gasses, doesn't penetrate porous surfaces effectively, and can leave residues irritating to bird respiratory systems. Quaternary ammonium disinfectants (like Oxine AH) or accelerated hydrogen peroxide products do a better job on coop surfaces. Reserve bleach for metal equipment you can rinse thoroughly."
  - q: "Does the deep litter method actually work, or is it just an excuse not to clean?"
    a: "It genuinely works when managed correctly, meaning you're adding fresh carbon material weekly and stirring the litter to introduce oxygen. It fails when people treat it as a reason to ignore the coop. Wet, compacted litter with no airflow isn't deep litter. It's just a mess with a fancy name."
  - q: "What's the fastest sign that your cleaning schedule isn't working?"
...
Scrape the roost bars clean with a paint scraper. I keep a dedicated one just for this purpose. Then hit the roosts with a diluted white vinegar solution (1:1 water/vinegar) or a poultry-safe disinfectant like [Oxine AH](https://www.amazon.com/s?k=Oxine+AH+poultry), which is what I switched to after a Marek's scare five years ago. Don't use bleach on porous wood. It off-gasses and doesn't penetrate deeply enough to justify the fume risk.
...
- Treat roost bars with a food-grade diatomaceous earth (DE) dusting after everything dries. I use [Perma-Guard Fossil Shell Flour](https://www.amazon.com/s?k=perma-guard+fossil+shell+flour+poultry). This is the one place I think DE is genuinely useful. It dries out mite eggs in crevices.
...
- My own pullet brooder mistake in my second year: I stretched the cleaning schedule to every 10 days thinking the litter was fine. It smelled okay to me. I lost a 4-week-old Speckled Sussex to what the vet called "exposure-related pneumonia." That was the last time I got complacent about ammonia. A simple [ammonia detection badge](https://www.amazon.com/s?k=ammonia+detection+badge) stuck to your coop wall at bird-height would've caught it. They cost about $12.

---

## Sources

- [University of Florida IFAS Extension, *Ammonia in Poultry Houses*](https://edis.ifas.ufl.edu/): Evidence-based thresholds for ammonia toxicity in poultry; recommends keeping levels below 25 ppm at bird height, with symptoms observable above 10 ppm in some breeds.
- [Penn State Extension, *Biosecurity for Backyard Poultry*](https://extension.psu.edu/): Covers cleaning and disinfection protocols, recommended contact times, and product classes for small-scale poultry operations.
...
- [National Chicken Council, *Poultry Health Management Guidelines*](https://www.nationalchickencouncil.org/): Industry-level data on litter moisture thresholds and ammonia generation rates, useful for scaling down to backyard contexts.

...
faqs:
  - q: "Can chickens eat bread?"
    a: "Yes, in small amounts, plain bread is generally safe. The issue is that bread has almost no nutritional value and can expand in the crop if wet. Feeding a lot of bread regularly pushes out nutritious food and can contribute to obesity and reduced laying. Keep it to a bite-sized occasional treat, not a regular scrap dump."
  - q: "Are cooked potatoes safe for chickens?"
    a: "Yes. Fully cooked white or sweet potatoes (plain, no seasonings) are safe and actually provide good energy. The danger is with the green parts of the potato plant, the skin of green potatoes, and all potato leaves, which contain solanine. Never feed raw or green potatoes."
  - q: "My chicken ate something it shouldn't have. What do I do?"
    a: "Stay calm and assess the situation. If the bird ate something mildly questionable, monitor closely for the next 24 to 48 hours. Watch for lethargy, labored breathing, neurological signs, or dramatic changes in droppings. If the bird ingested something genuinely toxic like avocado or raw beans, contact a poultry vet as soon as possible. Don't try to induce vomiting. Chickens don't have a vomiting reflex the way mammals do."
  - q: "Can chickens eat dairy products?"
...
|---|---|---|
| Ripe tomatoes | Yes | Leaves and green parts are toxic |
| Avocado | No | All parts contain persin |
| Cooked beans | Yes | Raw beans are highly toxic |
| Raw kidney beans | No | Even 3-4 can kill a hen |
| Leafy greens (kale, spinach) | Yes | Spinach in large amounts can inhibit calcium |
| Chocolate | No | Any amount is risky |
| Plain cooked rice | Yes | Good filler treat |
| Citrus fruit | Caution | Limit or avoid |
| Apples (no seeds) | Yes | Apple seeds contain cyanogenic compounds |
| Onions | Caution | Small amounts okay, large amounts harmful |
| Garlic | Caution | May taint egg flavor in excess |
| Mold/spoiled food | No | Always discard elsewhere |
| Rhubarb | No | Leaves especially toxic |
| Hard-boiled eggs | Yes | Excellent protein source |
| Raw eggs | No | Encourages egg-eating behavior |
| Salty snacks | No | Low sodium tolerance in birds |
...
2. **Limit treats to 10% of the diet.** Scraps and treats should make up no more than 10% of your flock's total daily intake. The rest should come from a quality balanced layer feed. When scraps replace feed, nutritional deficiencies develop fast. If you're not sure what type of feed to use, our guide on [chicken feed types explained](/chicken-feed-types-explained/) breaks down the options in detail.

3. **Cut food into appropriate sizes.** Large pieces of dense food can cause crop impaction. Dice root vegetables, break up bread into small pieces, and avoid anything stringy or fibrous that might tangle.

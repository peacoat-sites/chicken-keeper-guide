...
slug: "foxes-and-chickens"
affiliate_disclosure: false
faqs:
  - q: "Will a fox come back after it's gotten into a coop once?"
    a: "Almost certainly yes. A fox that has successfully raided a coop treats it as a reliable food source and will return, often the next night. You need to immediately address whatever entry point it used, and assume it will test every inch of the structure again before giving up."
  - q: "What time of year are fox attacks most common?"
    a: "Late winter through early summer is the highest-risk period. Foxes are raising kits from around February through June depending on your region, and a nursing vixen dramatically increases her hunting activity to feed them. That said, I've had fox pressure in every month of the year, so don't relax in fall and winter."
  - q: "How do I know if it was a fox and not another predator?"
    a: "Foxes typically carry birds off entirely, leaving scattered feathers at the kill site and along the escape route. Kills inside a coop with the bird left partially eaten point more toward a mink, weasel, or raccoon. A clean disappearance with feathers at the perimeter fence line is classic fox behavior."
  - q: "Is hardware cloth really necessary if my run is inside a larger fenced yard?"

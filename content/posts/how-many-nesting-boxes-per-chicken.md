...
What I actually recommend: one box for every three to four hens, with a hard minimum of three boxes no matter how small your flock. Even if you only have four birds, two boxes is asking for trouble. Hens are territorial about nesting, and the number two box in a two-box setup will get claimed by one hen who defends it like it's her 401k. The other hens pile into box one, eggs crack, tempers flare, and suddenly you've got a broody hen blocking traffic.

Here's something most people don't realize: it's not about simultaneous use nearly as much as it's about perceived availability. Hens will walk past an empty box to crowd into the one that smells like "everyone else laid here." More boxes means more options, which means fewer dominance standoffs and less stress on your lowest-ranking birds.

## Size and Placement Matter More Than the Count

You can have six perfectly-spaced nesting boxes and still have problems if they're the wrong size or in the wrong spot.
...
## When Your Math Is Technically Right but Still Failing

Twelve hens, four boxes. Should be fine. But every morning between 9 and 11 AM, you've got a traffic jam. Four hens laying, six waiting, two giving up and dropping eggs on the coop floor.

This is the laying schedule problem. Most hens in a healthy flock peak within the same two-hour window, especially in spring and early summer when day length is long and consistent. Your boxes aren't actually serving twelve birds spread across the day. They're serving twelve birds trying to use them in roughly 90 minutes. That changes the math considerably.

If you've got a flock where morning congestion is a real issue, adding one or two extra boxes beyond the formula recommendation is cheaper than dealing with the egg breakage, floor-laying habits, and occasional broody pileups. Extra boxes are a one-time cost. Broken eggs and stressed hens are ongoing.

One more thing that catches people off guard: when you add new hens, the box dynamics reset. Pullets coming into lay for the first time often won't use boxes that established hens have strongly claimed. I've had pullets lay on the floor for two weeks before finally joining the rotation. Having more boxes than you technically need gives newcomers a lower-stakes entry point.

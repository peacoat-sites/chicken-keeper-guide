---
title: "How To Safely Introduce New Chicks To Your Flock"
...
faqs:
 - q: "How long does it take for chicks to be fully accepted by the flock?"
   a: "Realistically, three to six weeks from first contact before you see something close to a stable pecking order. Some birds integrate faster, but don't assume smooth sailing until you've watched normal eating and roosting routines hold steady for at least two weeks."
 - q: "Can I introduce a single chick to an established flock?"
   a: "It's a bad idea and I wouldn't do it. A single bird has no ally, no one to displace attention onto, and will be the exclusive target of every adjustment peck. Introduce at least two chicks together if possible, ideally three. The social buffer matters."
 - q: "My hen is attacking the chicks through the wire divider. Is that a bad sign?"
   a: "Yes, she's telling you she's going to be a problem. It doesn't mean integration is impossible, but give it more time at the see-but-don't-touch stage, and plan to keep an eye on her specifically when you open things up. Some hens come around; some don't and need to be managed permanently or rehomed."
 - q: "Do I need to quarantine new chicks if they came from a hatchery?"
...
## First Contact: Make It Complicated on Purpose
...
Have a way to temporarily remove a problem bird if you need to. A dog crate nearby works well. Pulling the aggressor and leaving her out of the flock for a few days actually resets her social standing when she returns, which tends to knock the bully instinct down a notch.

Space is your best tool here. More square footage per bird means less conflict, full stop. The bare minimum is 10 square feet per bird in the run during integration, and I'd push that to 15 if you're working with known aggressive breeds like production Leghorns or some of the game bird crosses.
...
## Breeds That Make This Easier (and Harder)

Your existing flock's breed mix matters more than most guides acknowledge.

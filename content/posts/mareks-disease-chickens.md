...
date: 2026-05-29T12:30:39.748577+00:00
draft: false
...
- **Neurological (classical):** Leg, wing, or neck paralysis. Drooping wings. The most recognizable form.
- **Visceral (acute):** Rapid tumor formation on organs like the liver, spleen, and kidneys. Birds often die quickly with few obvious external signs.
...
## Managing an Active Outbreak: What You Can Actually Do

There's no treatment for Marek's disease. That's the hard truth. Once a bird is showing clinical signs, you're managing quality of life and making decisions about euthanasia, not curing anything.

**Practical steps when Marek's is active in your flock:**
...
|---|---|
| Source chicks from hatcheries that vaccinate at hatch | Vaccine must be given day one to be effective |
| Quarantine all new birds for 30 days minimum | Allows time for subclinical illness to surface |
| Avoid poultry swaps, fairs, and auctions | High-stress environments with birds from dozens of unknown sources |
| Don't share equipment with other chicken keepers | Feeders, waterers, and coops carry infectious dander |
| Select for genetic resistance over time | Some bloodlines carry lower susceptibility |
| Maintain good ventilation in the coop | Reduces airborne virus concentration |
| Keep stress low (overcrowding, sudden feed changes, predator pressure all suppress immunity) | Stressed birds are more susceptible to clinical disease |

Genetic resistance is an underappreciated factor. Certain breeds and strains have higher natural resistance to Marek's. White Leghorns used in commercial production have been selected for decades partly on Marek's resistance. Among heritage and backyard breeds, older strains of Rhode Island Reds, Buckeyes, and some Dominique lines show meaningful resistance. Show breeds and highly inbred exhibition lines tend to be more susceptible.

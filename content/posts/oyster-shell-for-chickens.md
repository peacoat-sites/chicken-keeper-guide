...
faqs:
  - q: "Can feeding too much oyster shell harm my chickens?"
    a: "It can, but it's rare with free-choice feeding. Excessive calcium over long periods can lead to kidney problems in laying hens, and it's genuinely harmful for roosters and young birds. The reason free-choice works so well is that hens self-regulate. They eat what they need and ignore it when they don't. Mixing oyster shell directly into feed in large quantities is where over-supplementation problems typically occur."
  - q: "My eggs are still thin even after I started offering oyster shell. What's wrong?"
    a: "Give it a couple of weeks first, since the improvement isn't instant. If shells are still poor after 2-3 weeks, consider other factors: Vitamin D3 deficiency (hens need sunlight or supplemented D3 to absorb calcium), a parasite load that's affecting nutrient absorption, or a bird-specific issue like an aging or damaged shell gland. Also double-check that the hens are actually eating the oyster shell."
  - q: "How do I know if my hens are eating the oyster shell at all?"
    a: "Check the level in the container every few days and watch for any obvious reduction. You can also observe the coop in the morning when hens are most active. High-production hens will typically visit the oyster shell station regularly. If the container sits untouched for weeks, your layer feed may already be providing enough calcium, or you might want to try a different brand or particle size."
  - q: "Is there a difference between coarse and fine oyster shell?"
...
### Can feeding too much oyster shell harm my chickens?

It can, but it's rare with free-choice feeding. Excessive calcium over long periods can lead to kidney problems in laying hens, and it's genuinely harmful for roosters and young birds. The reason free-choice works so well is that hens self-regulate. They eat what they need and ignore it when they don't. Mixing oyster shell directly into feed in large quantities is where over-supplementation problems typically occur.

### My eggs are still thin even after I started offering oyster shell. What's wrong?

Give it a couple of weeks first, since the improvement isn't instant. If shells are still poor after 2-3 weeks, consider other factors: Vitamin D3 deficiency (hens need sunlight or supplemented D3 to absorb calcium), a parasite load that's affecting nutrient absorption, or a bird-specific issue like an aging or damaged shell gland. Also double-check that the hens are actually eating the oyster shell.

### How do I know if my hens are eating the oyster shell at all?

Check the level in the container every few days and watch for any obvious reduction. You can also observe the coop in the morning when hens are most active. High-production hens will typically visit the oyster shell station regularly. If the container sits untouched for weeks, your layer feed may already be providing enough calcium, or you might want to try a different brand or particle size.

### Is there a difference between coarse and fine oyster shell?

Yes, and it matters. Coarse oyster shell (around 1-3mm particle size) is absorbed more slowly, which is ideal for laying hens since it releases calcium overnight when the shell is forming. Fine oyster shell or oyster flour is absorbed faster. For most backyard flocks, coarse oyster shell is the right choice.

### Should I give oyster shell to meat birds?

Generally, no. Meat breeds like Cornish Cross are slaughtered before they reach laying age, so calcium supplementation for eggshell production isn't relevant. Feeding high calcium to young, fast-growing broilers can actually stress their kidneys. Stick to the feeding program designed for meat birds.

...
Brooder temperature matters more than most guides let on. Too cold and chicks huddle, don't move enough, digestion slows, pasting follows. Too hot and they get dehydrated, gut motility drops, same result. The target is 95°F for week one, dropping 5°F per week. But here's the thing I got wrong for my first two years: I measured ambient air temperature at the edge of the brooder instead of directly under the heat source at chick level. Those readings can differ by 15 degrees. Get a digital thermometer with a probe (the $12 ThermoPro ones work fine) and put the probe where the chicks actually stand.

Feed transition is the third trigger. Chicks switching from the yolk sac to starter feed sometimes have loose or abnormally sticky stools in the adjustment period. This is normal and usually resolves in 48-72 hours, but it's also when pasting happens. Keep the brooder warm and monitor closely during this window.

## How to Actually Clean a Pasted Chick (Without Injuring It)

Do not pick at dry pasty butt with your fingernail. Do not. I made this mistake with my very first batch of Buff Orpingtons in 2016 and pulled skin off a chick. It survived, but it was entirely my fault and entirely avoidable.

The correct method:

Wet a soft cloth or cotton ball with warm water. Hold it gently against the pasted vent for 30-60 seconds. The goal is to soften the dried material so it releases on its own or with almost zero pressure. Re-wet and repeat as needed. Don't rush. If it's a serious build-up, this can take two or three rounds. Once clean, pat the area dry (wet chicks chill fast) and apply a tiny amount of plain coconut oil or plain petroleum jelly to the vent area. This prevents the next poop from sticking as aggressively.

Return the chick to the brooder immediately. Watch it. If it's been badly blocked, it may poop a large amount at once once the vent is clear. That's good. Watch it eat and drink within the next hour.

Working example: A reader named Gretchen from central Ohio messaged me in April about a batch of 25 Black Sex-Links from a mail-order hatchery. Twelve had varying degrees of pasting on arrival. She did twice-daily vent checks, used the warm soak method, applied coconut oil after each cleaning. Result: zero deaths from pasting, and by day five, zero new pasting events. The whole issue resolved itself once the chicks stabilized.
...
Working example: I switched from open dish feeders to port-style feeders in 2021 with a batch of 30 Easter Egger chicks. Combined with better brooder temperature control, pasty butt incidence dropped from roughly 35% of birds affected (my old average with shipped chicks) to around 10%, and those cases were mild and self-resolved within two days. Two changes, measurable difference.

## Sources

- Mountzouris, K.C. et al. (2020): "Effects of probiotic inclusion level in broiler nutrition on growth performance, gut microbiota composition, and intestinal morphology." *Poultry Science*. Relevant to probiotic use in stressed young chicks.
- Merck Veterinary Manual: "Cloacal Pasting in Poultry" -- clinical description of vent pasting, causes, and management. Available at merckvetmanual.com.
- University of Kentucky Cooperative Extension Service: "Brooding and Growing Chickens" -- practical brooder temperature guidance and chick husbandry basics.
- Iowa State University Extension: "Small-Scale Poultry Flocks" -- covers common health issues in backyard chick brooding, including digestive problems in the first week.
- National Poultry Improvement Plan (NPIP), current as of July 2026: Guidelines on hatchery health standards; context for understanding why shipped chicks carry higher stress-related health risks than locally hatched birds.

---


*Photo: [Stephen O.Ojeleye](https://www.pexels.com/@stephen-o-ojeleye-2149617206) via Pexels*
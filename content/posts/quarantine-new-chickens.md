...
image: "https://images.pexels.com/photos/9821451/pexels-photo-9821451.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
categories: ["health"]
tags: ["quarantine", "chickens"]
slug: "quarantine-new-chickens"
affiliate_disclosure: false
faqs:
  - q: "Do I need to quarantine chicks from a hatchery the same way I quarantine adult birds?"
    a: "Yes, but the risk profile is slightly different. Day-old chicks from large commercial hatcheries like Meyer or Cackle are Marek's vaccinated and have lower exposure history than adult birds from mixed flocks. That said, they can still carry Mycoplasma, coccidiosis, and other issues, and your adult hens have no immunity to whatever the chicks are carrying. Keep them separate until they're fully feathered and old enough to integrate, which doubles as natural quarantine time anyway."
  - q: "Can I quarantine birds inside my house if I don't have a separate outdoor space?"
    a: "Technically, yes. A large dog crate in a basement or garage works. The critical factor is that no shared air circulates between that space and wherever your flock lives. A house and a backyard coop rarely share direct airflow, so this can work. Use a brooder plate or heat lamp if it's cold, keep the space well-ventilated, and clean obsessively. It's not ideal, but it beats skipping quarantine entirely."
  - q: "What do I do if a bird gets sick during quarantine?"
  ...
  - q: "Should I quarantine birds I'm bringing back from a show or fair?"
...
I've seen keepers lose entire flocks because they bought "healthy-looking" birds at a swap meet and skipped the 30-day buffer. One respiratory illness moved through 14 birds in three weeks. Don't be that story.

## Setting Up a Proper Quarantine Space

Distance is the non-negotiable variable here. "Quarantine" doesn't mean a separate corner of the same coop. It means a separate building, or at minimum a space 50 feet away with no shared airflow. Respiratory pathogens travel on dust and dander. If you can smell your main coop from the quarantine pen, the air exchange is close enough to be a problem.

Your quarantine setup doesn't need to be elaborate. A small dog kennel inside a garage, a converted garden shed, or even a solid tractor with enclosed walls works fine. What it needs:

- Solid walls, not just wire, to block airborne particles
- Its own waterer and feeder that never cross into your main flock's area
- Bedding you'll dispose of separately after quarantine ends
- Enough space that the birds aren't stressed (stressed birds suppress immune function and skew your results)
...
Never count down from when you think they might be fine. Count from the day they arrived.
...
Run a fecal float if you can. Some farm vets and university extension offices offer low-cost fecal testing. Knowing your birds' parasite load before integration is genuinely useful information.

## Step-by-Step Integration After Quarantine

Assuming your birds pass quarantine with no illness and no treatment events, you still don't just open the gate and mix everyone together. Stress from pecking order disruption can spike cortisol enough to trigger latent illness. A structured introduction reduces that risk while establishing a functional hierarchy.

**Week 1: Look but don't touch**
Place the new birds in a temporary run or pen directly adjacent to your existing flock's area. They can see and hear each other through the wire. Nobody can make contact. This is the "visual introduction" phase and it dramatically reduces the intensity of initial confrontations.

**Week 2: Supervised overlap**
Let both groups share a large space for a few hours a day, ideally free-ranging in an open yard where there's room to flee and establish distance. Watch for sustained bullying (one bird cornered, being blocked from food and water repeatedly). Brief chasing is normal. Drawn blood is not.

**Week 3: Full integration**
Move new birds into the main coop at night. Hens reorganize pecking order more calmly in low light. Add a second feeder and waterer to reduce resource competition. Expect some tension for 7 to 14 more days.

| Phase | Duration | Key Action |
|---|---|---|
| Arrival quarantine | 30-60 days | Observation, health checks, treat parasites if needed |
| Visual introduction | 7 days | Adjacent pens, no contact |
| Supervised overlap | 7-14 days | Shared space with supervision |
| Full integration | Ongoing | Extra feeding stations, monitor for bullying |
...
Quarantine is unglamorous. It means extra setup, extra trips to a second pen, and a month of waiting when you're excited about new birds. But it's the single most effective thing you can do to protect a flock you've spent years building. The keepers who've been at this long enough have all lost birds to something preventable. Most of them quarantine religiously now. Learn from their losses, not your own.